 ...
 * @Last Modified time: 2018-01-11 16:28:32
 * @description:模态框
 */
...
(function(namespace) {
    var modalCom = Com.extends({
        ...
        loadData: function () {
            var self = this;
            if (this.currentOptions.children.itemOptions.dataType == "api") {
                $.common.ajax({
            ...
            } else if (this.currentOptions.children.itemOptions.dataType == "static") {
