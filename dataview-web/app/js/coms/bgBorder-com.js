 ...
 * @Last Modified time: 2018-01-08 15:45:38
 * @description:背景、边框
 */
...
(function (namespace) {
    var bgBorderCom = Com.extends({
        ...
        getBgBorderOption: function () {
            return {
                type7: 'images/bkg1.gif',
                type8: 'images/bkg2.gif',
                type9: 'images/bkg3.gif',
                type10: 'images/bkg4.gif',
                type11: 'images/bkg5.gif',
                type12: 'images/bkg6.gif',
            }
        },
        defaultOptions: {
            /* dataType: "static", */
        ...
        renderData: function () {
            ...
            if (this.currentOptions.borderType == "style7") {
                this.html.css("backgroundImage", 'url(' + globalVar.appUrl+ self.picOptions.type7 + ')');
            }
            else if (this.currentOptions.borderType == "style8") {
                this.html.css("backgroundImage", 'url(' + globalVar.appUrl + self.picOptions.type8 + ')');
            }
            else if (this.currentOptions.borderType == "style9") {
                this.html.css("backgroundImage", 'url(' + globalVar.appUrl + self.picOptions.type9 + ')');
            }
            else if (this.currentOptions.borderType == "style10") {
                this.html.css("backgroundImage", 'url(' + globalVar.appUrl + self.picOptions.type10 + ')');
            }
            else if (this.currentOptions.borderType == "style11") {
                this.html.css("backgroundImage", 'url(' + globalVar.appUrl + self.picOptions.type11 + ')');
            }
            else if (this.currentOptions.borderType == "style12") {
                this.html.css("backgroundImage", 'url(' + globalVar.appUrl + self.picOptions.type12 + ')');
            }else{
