 ...
 * @Last Modified time: 2018-01-04 16:42:13
 * @description:轮播列表
 */
        ...
        */
        listScroll: function () {
            ...
            if (this.currentOptions.rollingType == "seam") {
                ...
                var panelWidth = panel.width() * 2 + ulHtml.width();
                ...
                var panelWidth = ulHtml.width() * 2 + this.currentOptions.BlankWidth+1;
                panelTotle.css("width", panelWidth);
                marquee = function () {
                    // var oldList = $(".panelTotle ul", self.node);
